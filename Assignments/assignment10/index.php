...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initsial-scale=1, shrink-to-fit=no">
...
<body class="container">
    ...
    <p><?php echo $acknowledgement?></p>
        <form method="post" action="/~jmontagano/cps276/Assignments/assignment10/index.php" class="form-inline">
