...
class Db_conn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'jmontagano';//this will be your WCC username
      $dbUsr = 'jmontagano';//this will be your WCC username
      $dbPass = '3I6DE6MkKTwXOWl';//this will be the password found in the video.
